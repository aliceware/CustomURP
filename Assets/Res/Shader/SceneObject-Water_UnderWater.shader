Shader "RO/SceneObject/Water_UnderWater"
{
	Properties
	{
        [CustomHeader(RampTexture)]
		// _UnderWaterRamp("Color Ramp", 2D) = "black"{}
		...
		// _UnderWaterReflection("Reflection Cubemap", Cube) = "black"{}
		
		//_UnderWaterReflectionStrength("Reflection Strength", Range(0,10)) = 1

        [CustomHeader(Lighting)]
		//_UnderWaterSpecular("Specular", Range(0,10)) = 0.95
		_Smoothness("Smoothness", Range(0,1)) = 0.95
		// _UnderWaterSpecularOffset("Specular Offset", Vector) = (0, 0, 0, 0)
        [CustomHeader(Bump)]
	...
	SubShader
	{
		...
		Pass
		{
			...
			////////////////////INCLUDES//////////////////////
			#include "SceneObject-WaterUnder.hlsl"
