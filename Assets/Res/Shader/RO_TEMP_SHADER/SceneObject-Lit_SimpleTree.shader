Shader "RO/SceneObject/SimpleTree"
{
    Properties
	{
        ...
        SubShader
        {
            ...
            RO_OPAQUE_PIXEL_SHADER_FUNCTION(frag, v2f input)
            {
                UNITY_SETUP_INSTANCE_ID(input);
						...
						LODCrossFadeDitheringTransition(input.positionCS.xyz, _CrossFadeStart, _CrossFadeSpeed, _CrossFadeSign);
				#endif
                ...
                float alpha = (mainTex.a) - leaf_cut;
                ...
                return SubPassOutputColor(half4(color.rgb, 1), input.positionCS.z);
            }
            ENDHLSL
        }
