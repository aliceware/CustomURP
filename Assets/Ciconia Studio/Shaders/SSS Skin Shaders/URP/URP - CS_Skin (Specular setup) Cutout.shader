Shader "Ciconia/SSS Skin Cutout"
{
	Properties
	{
		...
		[Space(35)][Header(Cutout Properties________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________)][Space(15)][Toggle]_InvertCutout("Invert ", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float lerpResult872 = lerp( 1.0 , LightAttenuation661 , _LightAttenuationTranslucency);
				...
				float2 break26_g1171 = uv_EmissionMap;
				float2 appendResult14_g1171 = (float2(( break26_g1171.x * GlobalTilingX11 ) , ( break26_g1171.y * GlobalTilingY8 )));
				float2 appendResult13_g1171 = (float2(( break26_g1171.x + GlobalOffsetX10 ) , ( break26_g1171.y + GlobalOffsetY9 )));
				float4 temp_output_5_0_g1170 = ( _EmissionColor * tex2D( _EmissionMap, ( ( appendResult14_g1171 + appendResult13_g1171 ) + Parallaxe375 ) ) );
				float4 Emission110 = ( temp_output_5_0_g1170 * _EmissionIntensity );
				
				float2 uv_SpecGlossMap = IN.ase_texcoord7.xy * _SpecGlossMap_ST.xy + _SpecGlossMap_ST.zw;
				float2 break26_g1174 = uv_SpecGlossMap;
				float2 appendResult14_g1174 = (float2(( break26_g1174.x * GlobalTilingX11 ) , ( break26_g1174.y * GlobalTilingY8 )));
				float2 appendResult13_g1174 = (float2(( break26_g1174.x + GlobalOffsetX10 ) , ( break26_g1174.y + GlobalOffsetY9 )));
				float4 tex2DNode3_g1173 = tex2D( _SpecGlossMap, ( ( appendResult14_g1174 + appendResult13_g1174 ) + Parallaxe375 ) );
				float3 desaturateInitialColor508 = ( ( _SpecularColor * tex2DNode3_g1173 ) * _SpecularIntensity ).rgb;
				...
				float3 tanNormal42_g1173 = float4( Normal27 , 0.0 ).xyz;
				float fresnelNdotV42_g1173 = dot( float3(dot(tanToWorld0,tanNormal42_g1173), dot(tanToWorld1,tanNormal42_g1173), dot(tanToWorld2,tanNormal42_g1173)), WorldViewDirection );
				float fresnelNode42_g1173 = ( _FresnelBias + ( _SpecularIntensity * _FresnelIntensity ) * pow( max( 1.0 - fresnelNdotV42_g1173 , 0.0001 ), _Fresnelpower ) );
				float clampResult38_g1173 = clamp( fresnelNode42_g1173 , 0.0 , 1.0 );
				float SpecularFresnel645 = clampResult38_g1173;
				...
				float staticSwitch31_g1173 = ( tex2DNode3_g1173.a * _Glossiness );
				#elif defined(_SOURCE_BASECOLORALPHA)
				float staticSwitch31_g1173 = ( _Glossiness * BaseColorAlpha46 );
				#else
				float staticSwitch31_g1173 = ( tex2DNode3_g1173.a * _Glossiness );
				#endif
				float Smoothness40 = staticSwitch31_g1173;
				...
				float2 uv_CutoutMap = IN.ase_texcoord7.xy * _CutoutMap_ST.xy + _CutoutMap_ST.zw;
				float4 tex2DNode8_g1172 = tex2D( _CutoutMap, uv_CutoutMap );
				float4 temp_cast_20 = (BaseColorAlpha46).xxxx;
				float4 temp_cast_21 = (BaseColorAlpha46).xxxx;
				float4 clampResult24_g1172 = clamp( (( _InvertCutout )?( ( 1.0 - (( _UseBaseColorAlpha )?( temp_cast_21 ):( tex2DNode8_g1172 )) ) ):( (( _UseBaseColorAlpha )?( temp_cast_20 ):( tex2DNode8_g1172 )) )) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				...
				float Alpha = clampResult24_g1172.r;
		...
		Pass
		{
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_TARGET
			{
				...
				float2 uv_CutoutMap = IN.ase_texcoord2.xy * _CutoutMap_ST.xy + _CutoutMap_ST.zw;
				float4 tex2DNode8_g1172 = tex2D( _CutoutMap, uv_CutoutMap );
				...
				float4 tex2DNode7_g1153 = tex2D( _BaseMap, ( ( appendResult14_g1154 + appendResult13_g1154 ) + Parallaxe375 ) );
				float BaseColorAlpha46 = (( _InvertABaseColor1 )?( ( 1.0 - tex2DNode7_g1153.a ) ):( tex2DNode7_g1153.a ));
				float4 temp_cast_2 = (BaseColorAlpha46).xxxx;
				float4 temp_cast_3 = (BaseColorAlpha46).xxxx;
				float4 clampResult24_g1172 = clamp( (( _InvertCutout )?( ( 1.0 - (( _UseBaseColorAlpha )?( temp_cast_3 ):( tex2DNode8_g1172 )) ) ):( (( _UseBaseColorAlpha )?( temp_cast_2 ):( tex2DNode8_g1172 )) )) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_TARGET
			{
				...
				float4 temp_cast_16 = (BaseColorAlpha46).xxxx;
				float4 clampResult24_g1172 = clamp( (( _InvertCutout )?( ( 1.0 - (( _UseBaseColorAlpha )?( temp_cast_16 ):( tex2DNode8_g1172 )) ) ):( (( _UseBaseColorAlpha )?( temp_cast_15 ):( tex2DNode8_g1172 )) )) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_TARGET
			{
				...
				float4 temp_cast_15 = (BaseColorAlpha46).xxxx;
				float4 clampResult24_g1172 = clamp( (( _InvertCutout )?( ( 1.0 - (( _UseBaseColorAlpha )?( temp_cast_15 ):( tex2DNode8_g1172 )) ) ):( (( _UseBaseColorAlpha )?( temp_cast_14 ):( tex2DNode8_g1172 )) )) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
